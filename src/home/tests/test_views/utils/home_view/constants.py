...
LEGAL_AND_PRIVACY_LINK_ID_TEMPLATE = "legal_and_privacy-link-{id}"
LEGAL_AND_PRIVACY_MODAL_ID_TEMPLATE = "legal_and_privacy_modal_{id}"
LEGAL_AND_PRIVACY_TEXT_ID_TEMPLATE = "legal-and-privacy-text-{id}"
